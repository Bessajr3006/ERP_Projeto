        ...
        if (notasForm) {
            notasForm.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    const updateData = {
                        ie: document.getElementById('inscricaoEstadual')?.value?.trim() || null,
                        im: document.getElementById('inscricaoMunicipal')?.value?.trim() || null,
                        cnae_principal: document.getElementById('cnae')?.value?.trim() || null,
                        ...
                        csc_token: document.getElementById('cscToken')?.value?.trim() || null,
                        csc_id: document.getElementById('cscId')?.value?.trim() || null
                    };
                    await api(`/companies/${g_companyPublicId}`, {
                        method: 'PUT',
                        body: JSON.stringify(updateData)
