...
function injectWhatsAppButton() {
    if (window.location.pathname.includes('/pages/whatsapp.html'))
        return;
    if (document.getElementById('waFloatingBtn'))
        return;
...
function injectWhatsAppSidebar() {
    if (window.location.pathname.includes('/pages/whatsapp.html'))
        return;
    if (document.getElementById('waSidebarPanel'))
        return;
    // style
    const style = document.createElement('style');
    style.innerHTML = `
