    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        try {
            ...
            if (currentUserRole === 'super_admin') {
                ...
                showAlert('alertMessage', `Contexto do Super Admin: empresa ${label}. As permissões são por empresa. Para alterar as permissões do admin de outra empresa, vá em Empresas e clique em "Acessar Empresa" antes de editar.`, 'success', 12000);
            }
        ...
        getById('newRoleForm')?.addEventListener('submit', async (e) => {
            ...
            if (!slug)
                slug = 'perfil_' + Math.floor(Math.random() * 1000);
            btn.disabled = true;
