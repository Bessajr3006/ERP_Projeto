(() => {
    ...
    let taxesManager;
    const formatPerc = (val) => Number(val).toLocaleString('pt-BR', { minimumFractionDigits: 2 }) + '%';
    document.addEventListener('DOMContentLoaded', () => {
        ...
        taxesManager = new CrudManager({
            ...
            applyFilters: (data) => {
                ...
                const filtered = data.filter((item) => window.FilterPanel.matchesSearch(item, ['name', 'csosn', 'cst_icms', 'cst_pis', 'cst_cofins', 'service_code'], search));
