(() => {
    ...
    function renderStatCard(title, value, detail, tone) {
        const tones = {
    ...
    function renderSession(analytics) {
    ...
    function renderMessageTypes(analytics) {
    ...
    function renderConversations(analytics) {
    ...
    function renderRecentMessages(analytics) {
