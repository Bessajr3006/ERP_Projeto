...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    function renderTasks() {
        ...
        if (filtered.length === 0 && currentViewMode !== 'calendar') {
            ...
            <ul id="tasksList" class="space-y-3 pb-8">
                <li class="bg-white dark:bg-slate-800 rounded-2xl p-8 text-center border border-gray-200 dark:border-slate-700 shadow-sm transition-all hover:bg-gray-50 dark:hover:bg-slate-750">
