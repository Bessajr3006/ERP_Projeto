...
const uiPreferenceSchema = z.object({
    ...
    layout_width: z.enum(['system', 'max-w-5xl', 'max-w-6xl', 'max-w-7xl', 'max-w-screen-2xl']),
    nav_width: z.enum(['system', 'max-w-5xl', 'max-w-6xl', 'max-w-7xl', 'max-w-screen-2xl']).optional(),
    nav_color: hexColor,
